odoo.define('ketoan.ke_toan_bao_cao_so_cai', function (require) {
    'use strict';
...
//                            });
                            ...
                            if (initial_render) {
                                    self.$('.filter_view_tb').html(QWeb.render('SoCaiTimKiemView', {
...
//                                    });
                            ...
                            var child=[];
                        self.$('.table_view_tb').html(QWeb.render('SoCaiBangKetQuaView', {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'context': {
                        'active_model': 'ketoan.bao.cao.so.cai',
                        'landscape': 1,
