...
class UY_NHIEM_CHI_AGRIBANK_REPORT(models.AbstractModel):
    _name = 'report.account_ex.template_account_ex_phieu_chi_UNC_agribank'
    ...
    def get_report_values(self, docids, data=None):
        ...
        for record in records:
            if record.TAI_KHOAN_THU_NHAN_ID.TEN_NGAN_HANG:
