odoo.define('account_ex.account_ex_quy_phieu_thu_form_view', function (require) {
    "use strict";
    ...
    view_registry.add('account_ex_quy_phieu_thu_form_view', PhieuThuView);
    
    return PhieuThuView;
});

odoo.define('account_ex.account_ex_quy_phieu_thu_list_view', function (require) {
    "use strict";
    ...
    view_registry.add('account_ex_quy_phieu_thu_list_view', PhieuThuView);
