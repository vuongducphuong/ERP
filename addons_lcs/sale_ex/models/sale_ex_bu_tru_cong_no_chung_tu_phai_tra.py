...
class SALE_EX_BU_TRU_CONG_NO_CHUNG_TU_PHAI_TRA(models.Model):
    _name = 'sale.ex.bu.tru.cong.no.chung.tu.phai.tra'
    _description = ''
    _auto = False
    ...
    SO_CON_NO_QUY_DOI = fields.Float(string='Số còn nợ quy đổi', help='Số còn nợ quy đổi',digits=decimal_precision.get_precision('Product Price'))
    ...
    #   result = super(SALE_BU_TRU_CONG_NO_CHUNG_TU_PHAI_TRA, self).default_get(fields_list)
