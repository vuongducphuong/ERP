...
class SALE_EX_HOP_DONG_BAN_CHON_CHUNG_TU_CHI_FORM(models.Model):
    _name = 'sale.ex.hop.dong.ban.chon.chung.tu.chi.form'
    _description = ''
    _auto = False
    ...
    #   result = super(SALE_EX_HOP_DONG_BAN_CHON_CHUNG_TU_CHI_FORM, self).default_get(fields_list)
    #   result['FIELD_IDS'] = self.env['model.name'].search([]).ids
    #   return result
    SALE_EX_HOP_DONG_BAN_CHON_CHUNG_TU_CHI_CHI_TIET_FORM_IDS = fields.One2many('sale.ex.hop.dong.ban.chon.chung.tu.chi.chi.tiet.form', 'HOP_DONG_BAN_CHON_CHUNG_TU_CHI_ID', string='hợp đồng bán chọn chứng từ chi chi tiết form')
