odoo.define('stock_ex.nhap_xuat_kho_form_view', function (require) {
    "use strict";
    ...
    var NhapXuatKhoFormController = FormController.extend({
...
//                         ref_views: [['stock_ex.view_stock_ex_nhap_xuat_kho_chi_tiet_form', 'form']],
    ...
    var NhapXuatKhoFormView = FormView.extend({
        config: _.extend({}, FormView.prototype.config, {
            Controller: NhapXuatKhoFormController,
        }),
    });
    
    view_registry.add('nhap_xuat_kho_form_view', NhapXuatKhoFormView);
    
    return NhapXuatKhoFormView;
});

odoo.define('stock_ex.nhap_xuat_kho_list_view', function (require) {
    "use strict";
    ...
    var NhapXuatKhoListController = ListController.extend({
        // init: function () {
        //     this._super.apply(this, arguments);
        // },
    ...
    var NhapXuatKhoListView = ListView.extend({
        config: _.extend({}, ListView.prototype.config, {
            Controller: NhapXuatKhoListController,
        }),
    });
    
    view_registry.add('nhap_xuat_kho_list_view', NhapXuatKhoListView);
    
    return NhapXuatKhoListView;
});
