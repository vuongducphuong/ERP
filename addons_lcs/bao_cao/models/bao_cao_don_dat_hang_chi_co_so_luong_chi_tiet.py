...
class BAO_CAO_DON_DAT_HANG_CHI_CO_SO_LUONG_CHI_TIET(models.Model):
    _name = 'bao.cao.don.dat.hang.chi.co.so.luong.chi.tiet'
    _auto = False
    ...
    PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.don.dat.hang.chi.co.so.luong', string='Phiếu thu chi', help='Phiếu thu chi')
