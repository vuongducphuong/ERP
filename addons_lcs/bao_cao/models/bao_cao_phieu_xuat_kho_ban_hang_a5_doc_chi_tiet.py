...
class BAO_CAO_PHIEU_XUAT_KHO_BAN_HANG_A5_DOC_CHI_TIET(models.Model):
	_name = 'bao.cao.phieu.xuat.kho.ban.hang.a5.doc.chi.tiet'
	_auto = False
	...
	PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.phieu.xuat.kho.ban.hang.a5.doc', string='Phiếu thu chi', help='Phiếu thu chi')
