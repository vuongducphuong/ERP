...
class BAO_CAO_S03_A2_DN_SO_NHAT_KY_CHI_TIEN(models.Model):
    _name = 'bao.cao.s03.a2.dn.so.nhat.ky.chi.tien'
    ...
    TAI_KHOAN_NGAN_HANG_ID = fields.Many2one('danh.muc.tai.khoan.ngan.hang', string='TK ngân hàng', help='Tài khoản ngân hàng')
    ...
    GHI_CO_TK = fields.Char(string='Ghi Có TK', help='Ghi có tài khoản')
    TK_TRONG_1 = fields.Char(string=' ', help='Tk trống 1')
    TK_TRONG_2 = fields.Char(string=' ', help='Tk trống 2')
    TK_TRONG_3 = fields.Char(string=' ', help='Tk trống 3')
    TK_TRONG_4 = fields.Char(string=' ', help='Tk trống 4')
    ...
    def search_read(self, domain=None, fields=None, offset=0, limit=None, order=None):
        ...
        TAI_KHOAN_NGAN_HANG_ID = params['TAI_KHOAN_NGAN_HANG_ID'] if 'TAI_KHOAN_NGAN_HANG_ID' in params.keys() else 'False'
    ...
    def default_get(self,default_fields):
        res = super(BAO_CAO_S03_A2_DN_SO_NHAT_KY_CHI_TIEN, self).default_get(default_fields)
    ...
    def _action_view_report(self):
        ...
        action = self.env.ref('bao_cao.open_report__s03_a2_dn_so_nhat_ky_chi_tien').read()[0]
