...
class BAO_CAO_01TT_PHIEU_THU_CHI_TIET(models.Model):
    _name = 'bao.cao.01tt.phieu.thu.chi.tiet'
    _auto = False
    ...
    PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.01tt.phieu.thu', string='Phiếu thu chi', help='Phiếu thu chi')