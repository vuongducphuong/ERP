...
class BAO_CAO_PHIEU_XUAT_KHO_TONG_HOP_CHI_TIET(models.Model):
    _name = 'bao.cao.phieu.xuat.kho.tong.hop.chi.tiet'
    _auto = False
    
    NHAP_XUAT_ID = fields.Many2one('bao.cao.phieu.xuat.kho.tong.hop')
