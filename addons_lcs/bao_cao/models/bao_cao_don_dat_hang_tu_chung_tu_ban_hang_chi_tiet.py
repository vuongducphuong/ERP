...
class BAO_CAO_DON_DAT_HANG_CTBH_CHI_TIET(models.Model):
    _name = 'bao.cao.don.dat.hang.tu.ctbh.chi.tiet'
    _auto = False
    ...
    PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.don.dat.hang.tu.ctbh', string='Phiếu thu chi', help='Phiếu thu chi')
