...
class BAO_CAO_01TT_PHIEU_THU_MAU_A5_CHI_TIET(models.Model):
    _name = 'bao.cao.01tt.phieu.thu.a5.chi.tiet'
    _auto = False
    ...
    PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.01tt.phieu.thu.a5', string='Phiếu thu chi', help='Phiếu thu chi')
