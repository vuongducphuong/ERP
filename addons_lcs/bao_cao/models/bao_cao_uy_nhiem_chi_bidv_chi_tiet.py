...
class BAO_CAO_UNC_BIDV_CHI_TIET(models.Model):
    _name = 'bao.cao.uy.nhiem.chi.bidv.chi.tiet'
    _auto = False
    ...
    PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.uy.nhiem.chi.bidv', string='Phiếu thu chi', help='Phiếu thu chi')
