...
class BAO_CAO_GIAY_BAO_CO_CHI_TIET(models.Model):
    _name = 'bao.cao.giay.bao.co.chi.tiet'
    _auto = False
    ...
    PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.giay.bao.co', string='Phiếu thu chi', help='Phiếu thu chi')
