...
class BAO_CAO_S01_DN_NHAT_KY_SO_CAI(models.Model):
    _name = 'bao.cao.s01.dn.nhat.ky.so.cai'
    ...
    HIEN_THI_SO_HOA_DON = fields.Boolean(string='Hiện thị số hóa đơn ', help='Hiện thị số hóa đơn ')
    IN_BAO_CAO_THEO_DANG_MO_RONG = fields.Boolean(string='In báo cáo theo dạng mở rộng ', help='In báo cáo theo dạng mở rộng ')
    IN_BAO_CAO_THEO_DANG_MAU_DOC = fields.Boolean(string='In báo cáo theo dạng mẫu dọc', help='In báo cáo theo dạng mẫu dọc')
    THU_TU_DONG = fields.Integer(string='Thứ tự dòng', help='Thứ tự dòng')
    ...
    SO_TIEN_PHAT_SINH = fields.Float(string='Số tiền phát sinh ', help='Số tiền phát sinh ',digits=decimal_precision.get_precision('VND'))
    ...
    def default_get(self, fields_list):
        result = super(BAO_CAO_S01_DN_NHAT_KY_SO_CAI, self).default_get(fields_list)
    ...
    def search_read(self, domain=None, fields=None, offset=0, limit=None, order=None):
        ...
        IN_BAO_CAO_THEO_DANG_MO_RONG = params['IN_BAO_CAO_THEO_DANG_MO_RONG'] if 'IN_BAO_CAO_THEO_DANG_MO_RONG' in params.keys() else 'False'
        IN_BAO_CAO_THEO_DANG_MAU_DOC = params['IN_BAO_CAO_THEO_DANG_MAU_DOC'] if 'IN_BAO_CAO_THEO_DANG_MAU_DOC' in params.keys() else 'False'
    ...
    def _action_view_report(self):
        ...
        action = self.env.ref('bao_cao.open_report__s01_dn_nhat_ky_so_cai').read()[0]
