...
class BAO_CAO_UNC_SHB_CHI_TIET(models.Model):
    _name = 'bao.cao.uy.nhiem.chi.shb.chi.tiet'
    _auto = False

    
    SO_TIEN = fields.Monetary(string='Số tiền', help='Số tiền', currency_field='currency_id')
    PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.uy.nhiem.chi.shb', string='Phiếu thu chi', help='Phiếu thu chi')
