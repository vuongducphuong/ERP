...
class BAO_CAO_UNC_MB_CHI_TIET(models.Model):
    _name = 'bao.cao.uy.nhiem.chi.mb.chi.tiet'
    _auto = False
    ...
    PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.uy.nhiem.chi.mb', string='Phiếu thu chi', help='Phiếu thu chi')
