...
class BAO_CAO_02TT_PHIEU_CHI_MAU_A5_CHI_TIET(models.Model):
    _name = 'bao.cao.02tt.phieu.chi.mau.a5.chi.tiet'
    _auto = False
    ...
    PHIEU_THU_CHI_ID = fields.Many2one('bao.cao.02tt.phieu.chi.mau.a5', string='Phiếu thu chi', help='Phiếu thu chi')