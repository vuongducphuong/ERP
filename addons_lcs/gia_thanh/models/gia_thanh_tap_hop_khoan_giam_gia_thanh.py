...
class GIA_THANH_TAP_HOP_CHI_PHI_TRUC_TIEP(models.Model):
    _name = 'gia.thanh.tap.hop.khoan.giam.gia.thanh'
    _description = ''
    _auto = False
    ...
    #   return result
    GIA_THANH_TAP_HOP_KHOAN_GIAM_GIA_THANH_CHI_TIET_IDS = fields.One2many('gia.thanh.tap.hop.khoan.giam.gia.thanh.chi.tiet', 'CHI_TIET_ID', string='Tập hợp chi phí trực tiếp chi tiết')


    def lay_du_lieu_tap_hop_khoan_gia_thanh(self, args):
        ...
        return {'GIA_THANH_TAP_HOP_KHOAN_GIAM_GIA_THANH_CHI_TIET_IDS' : new_line_ket_chuyen_chi_phi_chi_tiet}
    ...
    def lay_du_lieu_tap_hop_cptt(self,ky_tinh_gia_thanh_id,chi_nhanh_id):
        ...
        query = """   
                ...
                THEN
                    ...
                    DROP TABLE IF EXISTS TMP_KET_QUA_DOI_TUONG_THCP
                    ;

                    CREATE TEMP TABLE TMP_KET_QUA_DOI_TUONG_THCP
                        AS
                            ...
                            SELECT
                                ...
                                , "DIEN_GIAI_CHUNG"
                                , "MA_TAI_KHOAN"
                                , SUM(COALESCE("GHI_CO", 0)) AS "SO_TIEN"
                                , GL."CONG_TRINH_ID"
                                , GL."TAI_KHOAN_ID"
                                , "MA_CONG_TRINH"
                                , "TEN_CONG_TRINH"
                            ...
                            WHERE "NGAY_HACH_TOAN" BETWEEN tu_ngay AND den_ngay
                                ...
                                AND "LOAI_HACH_TOAN" = '2' --Định khoản có
                                AND "MA_TAI_KHOAN_DOI_UNG" NOT LIKE '632%%'

                                AND "CHI_NHANH_ID" = chi_nhanh_id
                                AND (CHE_DO_KE_TOAN = '15'
                                    OR CHE_DO_KE_TOAN = '48'
                                        AND (EI."id" IS NULL
                                            OR EI."MA_PHAN_CAP" NOT LIKE MA_PHAN_CAPCPSX
                                                                            || '%%'
                                        )
                                )
                            GROUP BY
                                ...
                                "MA_KHOAN_MUC_CP",
                                "TEN_KHOAN_MUC_CP"
                            ORDER BY "MA_CONG_TRINH", "TEN_CONG_TRINH", "NGAY_HACH_TOAN", "NGAY_CHUNG_TU", "SO_CHUNG_TU",
                                "MA_TAI_KHOAN"
                    ;
                        ...
                        CREATE TEMP TABLE TMP_KET_QUA_DOI_TUONG_THCP
                            AS
                                ...
                                GROUP BY
                                    ...
                                    "MA_KHOAN_MUC_CP",
                                    "TEN_KHOAN_MUC_CP"
                                ORDER BY "DON_DAT_HANG", "NGAY_HACH_TOAN", "NGAY_CHUNG_TU", "SO_CHUNG_TU", "MA_TAI_KHOAN",
                                    "MA_KHOAN_MUC_CP"
                            ...
                            CREATE TEMP TABLE TMP_KET_QUA_DOI_TUONG_THCP
                                AS
                                    ...
                                    GROUP BY
                                        ...
                                        "MA_KHOAN_MUC_CP",
                                        "TEN_KHOAN_MUC_CP"
                                    ORDER BY "SO_HOP_DONG", "NGAY_HACH_TOAN", "NGAY_CHUNG_TU", "SO_CHUNG_TU", "MA_TAI_KHOAN",
                                        "MA_KHOAN_MUC_CP"
                                ...
                                FROM gia_thanh_ky_tinh_gia_thanh_chi_tiet AS JPD
                                    ...
                                    INNER JOIN danh_muc_doi_tuong_tap_hop_chi_phi AS J2
                                        ON J2."MA_PHAN_CAP" LIKE J."MA_PHAN_CAP"
                                                                || '%%'
                                WHERE "KY_TINH_GIA_THANH_ID" = ky_tinh_gia_thanh_id AND J2."isparent" = FALSE
                            ;
            ...
            SELECT *
            FROM TMP_KET_QUA_DOI_TUONG_THCP
