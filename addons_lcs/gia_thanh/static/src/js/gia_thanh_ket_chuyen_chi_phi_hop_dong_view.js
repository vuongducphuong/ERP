odoo.define('gia_thanh.ket_chuyen_chi_phi_hop_dong_form_view', function (require) {
    "use strict";
    ...
    var KetChuyenChiPhiHopDongFormController = FormController.extend({
        init: function () {
            this._super.apply(this, arguments);
        },
        _onCreate: function() {
            var self = this;
            var domain_san_xuat_lien_tuc_gian_don ='HOP_DONG';   
    ...
    var KetChuyenChiPhiHopDongFormView = FormView.extend({
        config: _.extend({}, FormView.prototype.config, {
           
            Controller: KetChuyenChiPhiHopDongFormController,
        }),
    });
    
    view_registry.add('ket_chuyen_chi_phi_hop_dong_form_view', KetChuyenChiPhiHopDongFormView);
    
    return KetChuyenChiPhiHopDongFormView;
});

odoo.define('gia_thanh.ket_chuyen_chi_phi_hop_dong_list_view', function (require) {
    "use strict";
    ...
    var KetChuyenChiPhiHopDongController = ListController.extend({
        _onCreate: function() {
            var self = this;
            var domain_san_xuat_lien_tuc_gian_don ='HOP_DONG';   
            new dialogs.FormViewDialog(this, {
    ...
    var KetChuyenChiPhiHopDongView = ListView.extend({
        config: _.extend({}, ListView.prototype.config, {
            Controller: KetChuyenChiPhiHopDongController,
        }),
    });
    
    view_registry.add('ket_chuyen_chi_phi_hop_dong_list_view', KetChuyenChiPhiHopDongView);
    
    return KetChuyenChiPhiHopDongView;
});
