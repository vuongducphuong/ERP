odoo.define('gia_thanh.ket_chuyen_chi_phi_don_hang_form_view', function (require) {
    "use strict";
    ...
    var KetChuyenChiPhiDonHangFormController = FormController.extend({
        init: function () {
            this._super.apply(this, arguments);
        },
        _onCreate: function() {
            var self = this;
            var domain_san_xuat_lien_tuc_gian_don ='DON_HANG';
    ...
    var KetChuyenChiPhiDonHangFormView = FormView.extend({
        config: _.extend({}, FormView.prototype.config, {
           
            Controller: KetChuyenChiPhiDonHangFormController,
        }),
    });
    
    view_registry.add('ket_chuyen_chi_phi_don_hang_form_view', KetChuyenChiPhiDonHangFormView);
    
    return KetChuyenChiPhiDonHangFormView;
});
odoo.define('gia_thanh.ket_chuyen_chi_phi_don_hang_list_view', function (require) {
    "use strict";
    ...
    var KetChuyenChiPhiDonHangController = ListController.extend({
        _onCreate: function() {
            var self = this;
            var domain_san_xuat_lien_tuc_gian_don ='DON_HANG';
    ...
    var KetChuyenChiPhiDonHangView = ListView.extend({
        config: _.extend({}, ListView.prototype.config, {
            Controller: KetChuyenChiPhiDonHangController,
        }),
    });
    
    view_registry.add('ket_chuyen_chi_phi_don_hang_list_view', KetChuyenChiPhiDonHangView);
    
    return KetChuyenChiPhiDonHangView;
});
