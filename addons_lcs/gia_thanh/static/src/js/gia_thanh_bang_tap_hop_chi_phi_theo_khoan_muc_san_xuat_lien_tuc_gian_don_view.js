odoo.define('gia_thanh.tinh_gia_thanh_bang_tap_hop_chi_phi_theo_khoan_muc_form_view', function (require) {
    "use strict";
    ...
    view_registry.add('tinh_gia_thanh_bang_tap_hop_chi_phi_theo_khoan_muc_form_view', TapHopChiPhiTheoKhoanMucFormView);
