...
class TestBasicFields(BaseImportCase):
    ...
    def get_fields(self, field):
        return self.env['base_import_ex.import'].get_fields('base_import.tests.models.' + field)
...
class TestMatchHeadersSingle(TransactionCase):
    ...
    def test_match_by_name(self):
        match = self.env['base_import_ex.import']._match_header('f0', [{'name': 'f0'}], {})
        self.assertEqual(match, [{'name': 'f0'}])

    def test_match_by_string(self):
        match = self.env['base_import_ex.import']._match_header('some field', [{'name': 'bob', 'string': "Some Field"}], {})
        self.assertEqual(match, [{'name': 'bob', 'string': "Some Field"}])

    def test_nomatch(self):
        match = self.env['base_import_ex.import']._match_header('should not be', [{'name': 'bob', 'string': "wheee"}], {})
    ...
    def test_recursive_match(self):
        ...
        match = self.env['base_import_ex.import']._match_header('f0/f1', [f], {})
    ...
    def test_recursive_nomatch(self):
        ...
        match = self.env['base_import_ex.import']._match_header('f0/f2', [f], {})
        self.assertEqual(match, [])
...
class TestMatchHeadersMultiple(TransactionCase):
    ...
    def test_noheaders(self):
        self.assertEqual(
            self.env['base_import_ex.import']._match_headers([], [], {}), ([], {})
        )
...
class test_convert_import_data(TransactionCase):
    """ Tests conversion of base_import_ex.import input into data which
