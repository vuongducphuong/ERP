...
QUnit.test('add import button in list', function(assert) {
    ...
    assert.ok(list.$buttons.find('.o_button_import_ex:contains(Import)').is(':visible'),
    ...
    list.$buttons.find('.o_button_import_ex:contains(Import)').click();
    list.destroy();
});
...
QUnit.test('list without import button', function(assert) {
    ...
    assert.ok(!list.$buttons.find('.o_button_import_ex').length, "should not have an Import button");
    list.destroy();
});
...
QUnit.test('add import button in kanban', function(assert) {
    ...
    assert.ok(kanban.$buttons.find('.o_button_import_ex:contains(Import)').is(':visible'),
        "should have a visible Import button");
    ...
    kanban.$buttons.find('.o_button_import_ex:contains(Import)').click();
    kanban.destroy();
});
...
QUnit.test('kanban without import button', function(assert) {
    ...
    assert.ok(!kanban.$buttons.find('.o_button_import_ex').length, "should not have an Import button");
    kanban.destroy();
});
