...
class TONG_HOP_BCTC_KIEM_TRA_KE_TOAN_KO_CAN_CHI_TIET_TK_FORM(models.Model):
    _name = 'tong.hop.bctc.kiem.tra.ke.toan.ko.can.chi.tiet.tk.form'
    _description = ''
    ...
    NGUYEN_NHAN = fields.Char(string='Nguyên nhân', help='Nguyên nhân')
