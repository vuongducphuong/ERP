...
class TIEN_ICH_XAY_DUNG_CONG_THUC_TMBCTC_LOAI_CHI_TIEU_CHI_TIET_MAC_DINH(models.Model):
    _name = 'tien.ich.xdct.tmbctc.lct.chi.tiet.mac.dinh'
    _description = ''
    ...
    CHI_TIET_ID_1 = fields.Many2one('tien.ich.thuyet.minh.bao.cao.tai.chinh.chi.tiet.mac.dinh', string='Chi tiết', help='Chi tiết', ondelete='cascade')
