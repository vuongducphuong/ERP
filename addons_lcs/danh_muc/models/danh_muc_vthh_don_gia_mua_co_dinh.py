...
class DANH_MUC_VTHH_DON_GIA_MUA_CO_DINH(models.Model):
    _name = 'danh.muc.vthh.don.gia.mua.co.dinh'
    _description = ''
    ...
    VAT_TU_HANG_HOA_CHI_TIET = fields.Integer(string='Vật tư hàng hóa chi tiết', help='Vật tư hàng hóa chi tiết')
