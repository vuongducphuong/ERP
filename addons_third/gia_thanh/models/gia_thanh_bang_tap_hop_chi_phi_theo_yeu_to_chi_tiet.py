...
class GIA_THANH_BANG_TAP_HOP_CHI_PHI_THEO_YEU_TO_CHI_TIET(models.Model):
    _name = 'gia.thanh.bang.tap.hop.chi.phi.theo.yeu.to.chi.tiet'
    _description = ''
    ...
    CHI_TIET_ID = fields.Many2one('gia.thanh.bang.tap.hop.chi.phi.theo.yeu.to',string='Chi tiết', help='Chi tiết')
    ...
    LUY_KE_NGUYEN_VAT_LIEU = fields.Float(string='Nguyên vật liệu', help='Nguyên vật liệu')
    LUY_KE_NHAN_CONG = fields.Float(string='Nhân công', help='Nhân công')
    LUY_KE_KHAU_HAO = fields.Float(string='Khấu hao', help='Khấu hao')
    LUY_KE_CHI_PHI_MUA_NGOAI = fields.Float(string='Chi phí mua ngoài', help='Chi phí mua ngoài')
    LUY_KE_CHI_PHI_KHAC = fields.Float(string='Chi phí khác', help='Chi phí khác')
