odoo.define('gia_thanh.tinh_gia_thanh_phan_bo_chi_phi_chung_hop_dong_form_view', function (require) {
    "use strict";
    ...
    var PhanBoChiPhiChungHopDongFormController = FormController.extend({
        init: function () {
        ...
        onViewLoaded: function(e, defer) {
            var self = this;
			var def =  defer;
            self.updateUI({'KY_TINH_GIA_THANH':self.params.tham_so,'KY_TINH_GIA_THANH_ONCHANGE':self.params.ky_tinh_gia_thanh_id,'LOAI_TINH_GIA_THANH' : 'HOP_DONG'});
            self.rpc_action({
    ...
    var PhanBoChiPhiChungHopDongFormView = FormView.extend({
        config: _.extend({}, FormView.prototype.config, {
            Controller: PhanBoChiPhiChungHopDongFormController,
        }),
    });
    
    view_registry.add('tinh_gia_thanh_phan_bo_chi_phi_chung_hop_dong_form_view', PhanBoChiPhiChungHopDongFormView);
    
    return PhanBoChiPhiChungHopDongFormView;
});
