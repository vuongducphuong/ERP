odoo.define('gia_thanh.tinh_gia_thanh_phan_bo_chi_phi_chung_don_hang_form_view', function (require) {
    "use strict";
    ...
    var PhanBoChiPhiChungDonHangFormController = FormController.extend({
        init: function () {
        ...
        onViewLoaded: function(e, defer) {
            var self = this;
			var def =  defer;
            self.updateUI({'KY_TINH_GIA_THANH':self.params.tham_so,'KY_TINH_GIA_THANH_ONCHANGE':self.params.ky_tinh_gia_thanh_id,'LOAI_TINH_GIA_THANH' : 'DON_HANG'});
            self.rpc_action({
    ...
    var PhanBoChiPhiChungDonHangFormView = FormView.extend({
        config: _.extend({}, FormView.prototype.config, {
            Controller: PhanBoChiPhiChungDonHangFormController,
        }),
    });
    
    view_registry.add('tinh_gia_thanh_phan_bo_chi_phi_chung_don_hang_form_view', PhanBoChiPhiChungDonHangFormView);
    
    return PhanBoChiPhiChungDonHangFormView;
});
