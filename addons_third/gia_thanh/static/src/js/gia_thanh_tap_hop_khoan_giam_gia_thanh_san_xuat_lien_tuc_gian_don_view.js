odoo.define('gia_thanh.tinh_gia_thanh_tap_hop_khoan_giam_gia_thanh_form_view', function (require) {
    "use strict";
    ...
    view_registry.add('tinh_gia_thanh_tap_hop_khoan_giam_gia_thanh_form_view', TapHopKhoanGiamGiaThanhFormView);
