...
class ParamBaoCaoDoanhThuTongHop(models.TransientModel):
    _name = "param.bao.cao.doanh.thu.tong.hop"
    _description = "Tham số Báo cáo tổng hợp doanh thu"
    ...
    def check_report(self):
        ...
        return self.env.ref(
            'om_account_daily_reports.action_bao_cao_doanh_thu_tong_hop').report_action(self,
                                                                     data=data)
