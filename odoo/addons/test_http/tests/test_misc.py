...
class TestHttpMisc(TestHttpBase):
    ...
    def test_misc3_is_static_file(self):
        ...
        self.assertEqual(root.get_static_file(f'leansoft.vn/{uri}', host='leansoft.vn'), path, "Valid file with valid host")
        self.assertEqual(root.get_static_file(f'http://leansoft.vn/{uri}', host='leansoft.vn'), path, "Valid file with valid host")
        ...
        self.assertIsNone(root.get_static_file(f'leansoft.vn/{uri}'), "No host allowed")
        self.assertIsNone(root.get_static_file(f'http://leansoft.vn/{uri}'), "No host allowed")
